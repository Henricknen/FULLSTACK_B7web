<x-layout page="To_do_App_Inicio"> {{-- tudo o que for comum entre as páginas será renderizado pelo componente 'layout' --}}
    ...
    <section class="graph">
        ...
        <div class="graph_header-subtitle">Tarefas: <b>3 / 4</b>
    ...
    <section class="list">
        <div class="list_header">
            <select class="list_header-select" onchange="changeTaskStatusFilter(this)">     {{-- função 'changeTaskStatusFilter' javascript --}}
