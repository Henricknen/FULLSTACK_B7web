...
class Usuario {
    ...
    public function setNome($n) {           // método público para definir o nome do usuário
    ...
    public function getNomeCompleto() {         // método público para retornar o nome completo do usuário
