...
class Usuario {     // classe tem mesma estrutura de dados da tabela 'usuarios' criada no banco de dados
    ...
    public function setEmail($e) {
        $this-> id = strtolower(trim($e));      // 'strtolower' passa o email para letras minúculas
    }
}
...
interface UsuarioDAO {      // classe que irá manipular o banco de dados
    ...
    public function findAll();      // 'findAll' retorna uma lista de todos objetos da classe 'Usuario', [READ]
    ...
    public function delete($id);        // 'delete' reçebe o 'id' do objeto e o deleta, [DELETE]
}